...
def insure_pay(request,id):
    ...
    to_acc = "0xC2a0715bAED62D5fC27377E62E66840f47160b7b"
    ...
    if request.POST:
        ...
        result = pay(account, to_acc, pk, 10)
        if result['done']:
...
def clime_insure(request):
    ...
    if request.POST:
        ...
        adhar = request.FILES.get("Aadhar")
        ...
        # Transwer money
        pk = "0xfa871c48c870f78d061cefa7a4cd546c3259befec9bfc01e0b69331f7d544c35"

        from_acc = "0xC2a0715bAED62D5fC27377E62E66840f47160b7b"
